...
export function archivoDto({ productoId, contentType, ext, filename }) {
  ...
  // van a iterar ese array y si hay una coincidencia incrementaran una variable x=0
  // y si al final de la iteracion la variable sigue estando en 0 (su valor inicial) 
  // entonces concluiremos que no esta dentro de los contenidos validos y emitiremos el error
